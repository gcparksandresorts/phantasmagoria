...
//---------------------------------------------------------------------------------------------------------------------------------- HEADER SETUP
	...
	function initializeHeader(){
		...
		if(window.innerWidth >= 675){
			...
			Header.innerHTML = "<div id='headerBar'></div><div id='headerSpacer'></div> <div id='hoverHider' onmouseover='showTTDmain()'></div> <div id='ttdSideMenu'></div> ";
...
//---------------------------------------------------------------------------------------------------------------------------------- FOOTER SETUP
	...
	function createMiniHeader(){ // Mobile Version
			...
			MHM.innerHTML = "<a href='https://gcparksandresorts.github.io/phantasmagoria'>Home</a>";
